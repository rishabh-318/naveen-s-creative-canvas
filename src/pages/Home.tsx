...
const Home = () => {
  ...
  return (
    <>
      <SoundPlayer src="/intro-pirates.mp3" volume={0.02} loop={true} />
      ...
      <div className="min-h-screen">
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            {/* Floating Square */}
            <div
              className="absolute top-40 right-20 w-24 h-24 bg-primary/20 blur-lg animate-float rotate-45"
              style={{ animationDelay: "1s" }}
            />

            {/* Floating Circle 2 */}
            <div
              className="absolute bottom-40 left-1/4 w-40 h-40 rounded-full bg-accent/30 blur-2xl animate-float"
            ...
            <div
              className="absolute top-1/4 right-1/3 w-6 h-6 rounded-full bg-white/40 animate-float"
              style={{ animationDelay: "1.5s" }}
            />
            <div
              className="absolute bottom-1/3 right-1/4 w-5 h-5 rounded-full bg-accent/60 animate-scale-pulse"
          ...
          <div className="container mx-auto relative z-10">
            <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16">
              ...
              <div className="max-w-4xl text-center lg:text-left space-y-8 animate-fade-in">
                <h1 className="text-2xl sm:text-5xl md:text-7xl font-bold leading-tight drop-shadow-2xl">
                  <span className="inline-block animate-slide-up text-white">
                    Social Media Strategist
                  </span>
                  <br />
                  <span
                    className="inline-block animate-slide-up text-accent drop-shadow-[0_0_30px_rgba(253,107,82,0.8)]"
                ...
                <p
                  className="text-lg sm:text-xl md:text-2xl text-white animate-fade-in drop-shadow-lg"
                  style={{ animationDelay: "0.4s" }}
                >
                  Crafting high-impact digital stories through strategy,
                  editing, and on-camera communication
                </p>
                <div
                  className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center sm:pt-6 animate-fade-in"
          ...
          <div className="container mx-auto">
            <div className="fade-in-section mb-16 text-center">
              ...
              <p className="sm:text-lg text-muted-foreground max-w-2xl mx-auto">
                A selection of projects that showcase my approach to Video
                Editing
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-sm sm:text-lg">
                <div className="p-6 bg-card rounded-xl">
                  ...
                  <p className="text-muted-foreground">
                    Engaging, platform-ready content crafted to capture
                ...
                <div className="p-6 bg-card rounded-xl">
                  ...
                  <p className="text-muted-foreground">
                    Precision editing and Motion Graphics for impactful
                    storytelling
                  </p>
                </div>
                <div className="p-6 bg-card rounded-xl">
                  ...
                  <p className="text-muted-foreground">
                    Strategic content planning and execution that boosts brand
